...
.. raw:: html
   ...
   <section class="subpage-hero animated-hero sensors-hero">
     ...
     <div class="subpage-hero-content">
       ...
       <h1>Sensors and Imaging</h1>
       <p>
         LiDAR, motion capture, thermal imaging, hyperspectral cameras, acoustic systems,
         and event-based vision tools.
       </p>
     </div>
   </section>

   <section class="subpage-intro">
     <h2>Available Sensors and Imaging Systems</h2>
