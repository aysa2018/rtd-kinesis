...
.. raw:: html
   ...
   <section class="subpage-hero animated-hero air-hero">
     ...
     <div class="subpage-hero-content">
       ...
       <h1>Air Systems</h1>
       <p>
         Drones and aerial platforms for mapping, inspection, imaging, and experimental
         flight operations.
       </p>
     </div>
   </section>
